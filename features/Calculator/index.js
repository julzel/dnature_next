...
const Calculator = () => {
  ...
  const renderIntro = () => (
    <>
      ...
      <p>
        ...
        distintos factores que determinan la cantidad de energía y nutrientes
        que necesita para llevar una vida plena.
      </p>
      <p>
        Calcula la ración diaria de las Recetas completas de DNAture completando
  ...
  return (
    <section className={styles.calculator}>
      <div className={styles.calculatorIntro}>{renderIntro()}</div>
      {startCalculator && (
        <>
