  ...
  const renderControls = () => {
    ...
    return (
      <div className={styles.calculatorControls}>
        ...
        {step < 6 && enableNext && (
          <button onClick={hadleNextClick}>Siguiente</button>
        )}
      </div>
    );
  };
  ...
  const renderAgeSelect = (cb) => (
    <div className={styles.step}>
      ...
      <div
        role="button"
        tabIndex="0"
        onClick={() => cb('age', 'adulto')}
        className={dogProfile.age === 'adulto' ? styles.selected : ''}
      >
        Adulto
      </div>
      <div
        role="button"
        tabIndex="0"
        onClick={() => cb('age', 'cachorro')}
        className={dogProfile.age === 'cachorro' ? styles.selected : ''}
      >
        Cachorro
      </div>
    </div>
  ...
  const renderPuppyStage = (cb) => (
    <div className={styles.step}>
      ...
      <div
        role="button"
        tabIndex="0"
        onClick={() => cb('stage', 'stage1')}
        className={dogProfile.stage === 'stage1' ? styles.selected : ''}
      >
      ...
      <div
        role="button"
        tabIndex="0"
        onClick={() => cb('stage', 'stage2')}
        className={dogProfile.stage === 'stage2' ? styles.selected : ''}
      >
      ...
      <div
        role="button"
        tabIndex="0"
        onClick={() => cb('stage', 'stage3')}
        className={dogProfile.stage === 'stage3' ? styles.selected : ''}
      >
  ...
  const renderSizeSelect = (cb) => (
    <div className={styles.step}>
      ...
      <div
        role="button"
        tabIndex="0"
        onClick={() => cb('size', 'pequeno')}
        className={dogProfile.size === 'pequeno' ? styles.selected : ''}
      >
      ...
      <div
        role="button"
        tabIndex="0"
        onClick={() => cb('size', 'mediano')}
        className={dogProfile.size === 'mediano' ? styles.selected : ''}
      >
      ...
      <div
        role="button"
        tabIndex="0"
        onClick={() => cb('size', 'grande')}
        className={dogProfile.size === 'grande' ? styles.selected : ''}
      >
  ...
  const renderCastratedSelect = (cb) => (
    <div className={styles.step}>
      ...
      <div
        role="button"
        tabIndex="0"
        onClick={() => cb('castrated', 'noCastrado')}
        className={dogProfile.castrated === 'noCastrado' ? styles.selected : ''}
      >
        Sin castrar
      </div>
      <div
        role="button"
        tabIndex="0"
        onClick={() => cb('castrated', 'castrado')}
        className={dogProfile.castrated === 'castrado' ? styles.selected : ''}
      >
        Castrado
      </div>
    </div>
  ...
  const renderWeightStatusSelect = (cb) => (
    <div className={styles.step}>
      ...
      <div
        role="button"
        tabIndex="0"
        onClick={() => cb('weightStatus', 'bajoPeso')}
        className={
          dogProfile.weightStatus === 'bajoPeso' ? styles.selected : ''
        }
      >
        Bajo peso
      </div>
      <div
        role="button"
        tabIndex="0"
        onClick={() => cb('weightStatus', 'pesoIdeal')}
        className={
          dogProfile.weightStatus === 'pesoIdeal' ? styles.selected : ''
        }
      >
        Ideal
      </div>
      <div
        role="button"
        tabIndex="0"
        onClick={() => cb('weightStatus', 'sobrepeso')}
        className={
          dogProfile.weightStatus === 'sobrepeso' ? styles.selected : ''
        }
      >
        Sobrepeso
      </div>
  ...
  const renderActivitySelect = (cb) => (
    <div className={styles.step}>
      ...
      <div
        role="button"
        tabIndex="0"
        onClick={() => cb('activity', 'sedentario')}
        className={dogProfile.activity === 'sedentario' ? styles.selected : ''}
      >
        Sedentario
      </div>
      <div
        role="button"
        tabIndex="0"
        onClick={() => cb('activity', 'activo')}
        className={dogProfile.activity === 'activo' ? styles.selected : ''}
      >
        Activo
      </div>
      <div
        role="button"
        tabIndex="0"
        onClick={() => cb('activity', 'deportista')}
        className={dogProfile.activity === 'deportista' ? styles.selected : ''}
      >
        Deportista
      </div>
    </div>
      ...
      <div className={styles.profile}>
        <div className={styles.profileResults}>
          {result ? (
            <div>
              <h3>
                {result}g <span>al día</span>
              </h3>
            </div>
          ) : (
            <p className={styles.warning}>
              Por favor ingrese un valor de peso correcto
            </p>
          )}
        </div>
        <div className={styles.profileDetails}>
          {Object.keys(dogProfile).map((key, i) => (
            <div key={i}>
              <span>{labelKeys[key]}:&nbsp;</span>
              <span>
                {key === 'weight'
                  ? `${dogProfile[key]}kg`
                  : valueKeys[dogProfile[key]]}
              </span>
            </div>
          ))}
        </div>
