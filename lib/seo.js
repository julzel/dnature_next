...
export function generateOrganizationSchema() {
  return {
    ...
    description: 'Nutrición personalizada para mascotas basada en análisis de ADN',
    address: {
      '@type': 'PostalAddress',
      addressCountry: 'CR',
...
export function generateProductSchema(product) {
  ...
  const schema = {
    ...
    description: product.description?.replace(/<[^>]*>/g, '') || `${product.productName} - Nutrición natural para mascotas`,
