        ...
        return (
          <Button
            ...
            sx={{
              ...
              lineHeight: 1.5,
              letterSpacing: 0.2,
              backgroundColor: (theme) => active ? alpha(theme.palette.common.white, 0.18) : 'transparent',
              borderColor: (theme) => active ? alpha(theme.palette.common.white, 0.4) : 'transparent',
              transition: 'background-color 0.2s ease, border-color 0.2s ease',
              '&:hover': {
                backgroundColor: (theme) => alpha(theme.palette.common.white, active ? 0.28 : 0.16),
