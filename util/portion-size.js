...
const labelKeys = {
  ...
  bodyContexture: 'Contextura',
  dailyActivity: 'Actividad física',
  puppyStage: 'Etapa del cachorro',
...
const valueKeys = {
  ...
  puppy: 'Cachorro',
  castrated: 'Castrado',
  notCastrated: 'Sin castrar',
  small: 'Mini',
  medium: 'Pequeño - Mediano',
  large: 'Grande - Gigante',
